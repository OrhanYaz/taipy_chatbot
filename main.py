...
def handle_file_upload(state: State, file_info: dict):
    if file_info:
...
# Konecranes **GPT**{: .color-primary} # {: .logo-text}
<|{content}|file_selector|label=Download File|on_action=handle_file_upload|extensions=.csv,.xlsx|drop_message=Drop Message|>
